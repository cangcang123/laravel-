              ...
              <form action="{{route('admin.checklogin')}}" method="POST">
                ...
                <div class="row">
                  <div class="form-group col-md-12 mb-4">
                    <input type="text" class="form-control input-lg" id="username" aria-describedby="emailHelp" placeholder="Username" name="username">
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="d-flex my-2 justify-content-between">
                      ...
                      <p><a class="text-blue" href="{{route('admin.index')}}">Forgot Your Password?</a></p>
                    </div>
                    <button type="submit" class="btn btn-lg btn-primary btn-block mb-4" name="bntlogin">Sign In</button>
                    <p>Don't have an account yet ?
                      <a class="text-blue" href="./Listname/showlist">Sign Up</a>
                    </p>
                  </div>
                </div>
              </form>
